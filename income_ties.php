...
$output = _("You have the option of contributing a percentage of any income")." (".strtolower($site_settings->getUnitString()).") "._("you receive to another account. If you specify an Income Share, every time you receive")." ".strtolower($site_settings->getUnitString())." "._("a specified percentage (of your choosing) will automatically be paid to the account of your choice. You can change this arrangement at any time, but you are only allowed to share your income with one other account at a time.")."<p>";
...
if (!$myTie) { // No Income Tie found
	...
	$output .= _("I would like to share")." <input type=text size=1 maxlength=2 name=amount value=10>% "._("of any")." ".strtolower($site_settings->getUnitString())." "._("I receive")."...<p>";
